 ...
 * @return {*}
 */
const DailyAnaylse = (props: MonthAnlyseProps) => {
  ...
  useEffect(() => {
    ...
    setChartWidth(option.series[0].data.length * 30);
  ...
  return (
    ...
    >
      <ScrollView scrollX>
        <EChart ref={echartsRef} height={200} width={chartWidth}></EChart>
      </ScrollView>
    </AnalyseCard>
  );
};

export default DailyAnaylse;
